...
class TestBuchiAutomataBaseClass(unittest.TestCase):
    ...
    def test_compose(self):
        states1 = {'q0', 'q1'}
        alphabet1 = {'a', 'b'}
        transitions1 = {'q0': {'a': {'q1'}, 'b': {'q0'}}, 'q1': {'a': {'q1'}, 'b': {'q0'}}}
        initial_state1 = 'q0'
        accepting_states1 = {'q1'}
        automaton1 = BuchiAutomaton(states1, alphabet1, transitions1, initial_state1, accepting_states1)

        states2 = {'p0', 'p1'}
        alphabet2 = {'a', 'b'}
        transitions2 = {'p0': {'a': {'p1'}, 'b': {'p0'}}, 'p1': {'a': {'p1'}, 'b': {'p0'}}}
        initial_state2 = 'p0'
        accepting_states2 = {'p1'}
        automaton2 = BuchiAutomaton(states2, alphabet2, transitions2, initial_state2, accepting_states2)
